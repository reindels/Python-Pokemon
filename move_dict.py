...
'category': constants.move_category_special,
'description': "",
'effects': ["{} {} {} {}".format(constants.reduces, constants.pkm_self, constants.special_attack, constants.by_2_stages)],
'power': 130,
'accuracy': 90,
'pp': 5
}
...
'category': constants.move_category_status,
'description': "",
'effects': ["Prevents all Pokemon from falling asleep for 5 turns."],
'power': None,
'accuracy': None,
'pp': 10
}
...
'category': constants.move_category_physical,
'description': "",
'effects': ["{} {} {} {}".format(constants.increases, constants.pkm_self, constants.speed, constants.by_1_stage)],
'power': 50,
'accuracy': 100,
'pp': 20
}
...
'category': constants.move_category_status,
'description': "",
'effects': ["10% chance", constants.reduces, constants.pkm_foe, constants.special_defense, constants.by_1_stage],
'power': 120,
'accuracy': 70,
'pp': 5
}
...
'category': constants.move_category_special,
'description': "",
'effects': ["Hits Pokemon using Fly/Bounce with double power."],
'power': 40,
'accuracy': 100,
'pp': 35
}
...
'type': constants.type_normal,
'category': constants.move_category_status,
'effects': ["{} {} {}".format(constants.pkm_self, constants.inflict, constants.status_perish_song),
"{} {} {}".format(constants.pkm_foe, constants.inflict, constants.status_perish_song)],
'description': "",
'power': None,
'accuracy': None,
'pp': 5
...
'type': constants.type_fairy,
'category': constants.move_category_physical,
'effects': ["{} {} {} {} {}".format("10% chance", constants.pkm_foe, constants.reduces, constants.attack, constants.by_1_stage)],
'description': "",
'power': 90,
'accuracy': 90,
'pp': 10
...
'type': constants.type_rock,
'category': constants.move_category_physical,
'effects': ["Makes Flying-type Pokemon vulnerable to Ground moves."],
'description': "",
'power': 50,
'accuracy': 100,
'pp': 15
...
'type': constants.type_normal,
'category': constants.move_category_physical,
'effects': ["{} {} {}".format(constants.pkm_foe, constants.remove, constants.status_paralysis)],
...
'description': "The opposing Pokemon are bound with silk blown from the user's mouth that harshly lowers the Speed stat.",
'power': None,
'accuracy': 95,
'pp': 40
}
...
'type': constants.type_psychic,
'category': constants.move_category_special,
'effects': ["Hits any Pokemon that shares a type with the user."],
'description': "",
'power': 120,
'accuracy': 100,
'pp': 15
...
'type': constants.type_dark,
'category': constants.move_category_status,
'effects': ["{} {} {}".format(constants.pkm_foe, constants.inflict, constants.status_taunted)],
'description': "",
'power': None,
'accuracy': 100,
'pp': 20
...
'type': constants.type_normal,
'category': constants.move_category_special,
'effects': ["Type depends on the Drive being held."],
'description': "",
'power': 85,
'accuracy': 100,
'pp': 5
...
"Hits Pokemon using Fly/Bounce with double power."],
'description': "",
'power': 40,
'accuracy': 100,
'pp': 20
...
'type': constants.type_psychic,
'category': constants.move_category_status,
'effects': ["Swaps every Pokemon's Defense and Special Defense for 5 turns."],
'description': "",
'power': None,
'accuracy': None,
'pp': 10
